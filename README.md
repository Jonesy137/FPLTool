...
**FPLAnalytics.ipynb** - A notebook where I perform analysis on the data obtained from the FPL API, and create
...
**elements_teams.csv** - A csv file which is the merge of teams and elements,
this allows us to link what player plays for what team.